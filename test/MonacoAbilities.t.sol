...
contract MonacoAbilitiesTest is Test {
    ...
    function testAction_banana() public {
        ...
        monaco.setCarData(mockCar2, Monaco.CarData({balance: 15000, car: mockCar2, speed: 200, shield:0, y: carPosition}));
    ...
    function testAction_banana_collision() public {
        ...
        monaco.setCarData(mockCar2, Monaco.CarData({balance: 15000, car: mockCar2, speed: 0, shield:0, y: bananaPos}));
        mockCar2.setAction(Monaco.ActionType.BANANA, 1);

        uint32 car3Speed1 = 60;
        monaco.setCarData(mockCar3, Monaco.CarData({balance: 15000, car: mockCar3, speed: car3Speed1, shield:0, y: 0}));
    ...
    function testAction_banana_multipleCollision() public {
        ...
        monaco.setCarData(mockCar2, Monaco.CarData({balance: 15000, car: mockCar2, speed: 100, shield:0, y: 50}));
    ...
    function testAction_shell_banana() public {
        ...
        monaco.setCarData(mockCar1, Monaco.CarData({balance: 15000, car: mockCar1, speed: 100, shield:0, y: car1Position}));

        uint32 car2Position = 50;
        monaco.setCarData(mockCar2, Monaco.CarData({balance: 15000, car: mockCar2, speed: 100, shield:0, y: car2Position}));
        mockCar2.setAction(Monaco.ActionType.SHELL, 1);
