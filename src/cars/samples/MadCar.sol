...
contract MadCar is ICar {
    ...
    function buyAsMuchAccelerationAsSensible(
        ...
        uint baseCost = 25;
        uint speedBoost = ourCar.speed < 5 ? 5 : ourCar.speed < 10
            ? 3
            : ourCar.speed < 15
            ? 2
            : 1;
        uint yBoost = ourCar.y < 100 ? 1 : ourCar.y < 250 ? 2 : ourCar.y < 500
            ? 3
            : ourCar.y < 750
            ? 4
            : ourCar.y < 950
    ...
    function takeYourTurn(
        ...
        Monaco.CarData memory nextCarAhead = is1stPosition
            ? ourCar
            : isCar1Ahead
            ? otherCar1
            : otherCar2;
        ...
        if (hasCarAhead)
            buy1ShellIfSensible(monaco, ourCar, nextCarAhead.speed);
